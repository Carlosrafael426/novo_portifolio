...
export function TechnologyGroup({ category, technologies }: TechnologyGroupProps) {
  ...
  return (
    <div className="group border-border bg-card hover:border-accent/60 rounded-lg border p-6 transition-colors duration-300">
      <div className="flex flex-col items-center text-center">
        <div className="relative flex h-16 w-16 items-center justify-center">
          <Hexagon
            aria-hidden="true"
            strokeWidth={1}
            className="text-accent/70 absolute inset-0 h-full w-full transition-transform duration-500 ease-out group-hover:rotate-30"
          />
          <Icon aria-hidden="true" strokeWidth={1.5} size={22} className="text-accent relative" />
        </div>
